...
export const SEARCH_DATA: SearchCategories = {
    WOMEN: [
        ...
        { name: "Shirts", image: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?q=80&w=300&auto=format&fit=crop" },
        { name: "Bottoms", image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=300&auto=format&fit=crop" },
        { name: "Skirts", image: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?q=80&w=300&auto=format&fit=crop" },
        { name: "Summer", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=300&auto=format&fit=crop" },
        ...
        { name: "Purse", image: "https://images.unsplash.com/photo-1559563458-527698bf5295?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
        { name: "Sport Utility", image: "https://images.unsplash.com/photo-1571731956672-f2b94d7dd0cb?q=80&w=300&auto=format&fit=crop" },
        ...
        { name: "Graphic Tees ", image: "https://images.unsplash.com/photo-1503342394128-c104d54dba01?q=80&w=300&auto=format&fit=crop" },
    ],
    MEN: [
        { name: "Sweater", image: "https://cantabilshop.com/cdn/shop/products/MSWL00061_SKYMELANGE_1.jpg?v=1751348296&width=990" },
        ...
        { name: "Pants", image: "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?q=80&w=300&auto=format&fit=crop" },
        ...
        { name: "Hoodie", image: "https://cantabilshop.com/cdn/shop/files/MTRS00048_GREY_1.jpg?v=1768393555&width=990" }
    ],
    KIDS: [
        { name: "Tops", image: "https://cantabilshop.com/cdn/shop/files/BSHC00104_GREEN_1.jpg?v=1765021480&width=990" },
        ...
        { name: "Loungewe", image: "https://images.unsplash.com/photo-1571210862729-78a52d3779a2?q=80&w=300&auto=format&fit=crop" },
